...
/**
 * Performs all operations connected with zip files
 */
    ...
    public void createZip(Path source) throws Exception {
        ...
        try (ZipOutputStream zipOutputStream = new ZipOutputStream(Files.newOutputStream(zipFile))) {
            ...
            if (Files.isDirectory(source)) {
                // If archiving a directory, then get the list of files it contains
                ...
                // If archiving an individual file, then get its directory and name
